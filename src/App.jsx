  ...
  return (
    <>
      <div className='flex bg-zinc-800  w-screen h-screen text-2xl font-bold  text-dimWhite   '>
                <div className=' flex flex-col  ml-2 mt-1 grow bg-cmpgrey border-2 border-rose-500 '  >{
        ...
        <div className=' flex flex-col  ml-3 mt-1 grow bg-cmpgrey border-2 border-rose-500'  >{
